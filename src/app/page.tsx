          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center">
              ...
              <div className="space-y-2 text-gray-400 text-sm font-montserrat">
                ...
                <p>Le catalogue c&apos;est 180+ oeuvres soigneusements choisies...</p>
              ...
              <div className="flex flex-col gap-3 space-y-3 text-gray-300 text-sm font-montserrat">
                ...
                <div className="flex justify-center md:justify-end space-x-4">
                  ...
                  {defaultArtistData.socialMedia?.linkedin && (
                    <a
                      href={`https://linkedin.com/${defaultArtistData.socialMedia.linkedin}`}
                      target="_blank"
                  ...
                  {/* Pinterest */}
                  {defaultArtistData.socialMedia?.pinterest && (
                    <a
                      href={`https://pinterest.com/${defaultArtistData.socialMedia.pinterest}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-400 hover:text-white transition-colors"
                    >
