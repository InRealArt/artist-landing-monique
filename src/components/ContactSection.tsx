        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              {artistData.phone && (
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{artistData.phone}</p>
                  </div>
                </div>
              )}
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">{artistData.location}</p>
                </div>
              </div>
            </div>
            ...
            {artistData.socialMedia && (
              <div className="mt-8">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Follow the Artist</h3>
                <div className="flex space-x-4">
                  ...
                  {artistData.socialMedia.facebook && (
                    <a
                      href={`https://facebook.com/${artistData.socialMedia.facebook}`}
                      target="_blank"
                      rel="noopener noreferrer"
            ...
            <div className="mt-8 p-6 bg-white rounded-lg shadow-sm">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <p>• Commissions are welcome</p>
                <p>• Shipping available worldwide</p>
                <p>• Payment plans available for larger pieces</p>
